...
if __name__ == "__main__":
    ...
    parser.add_argument("--cpp_dir", type=str, default= "../externals", help="The directory in which the mesh-tools folder is located.")
    parser.add_argument("--dataset_dir", type=str, default= "../dataset", help="The directory in which the dataset folders are located.")
